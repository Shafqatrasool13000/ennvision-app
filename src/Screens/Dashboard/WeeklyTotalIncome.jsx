...
const WeeklyTotalIncome = () => {
    ...
    const rolesAndCommissionsData = [{
        title: 'Admin', week_income: '$455', monthly_income: '$75000'
    },{
        title: 'Fleet', week_income: '$455', monthly_income: '$75000'
    },{
        title: 'Vendor', week_income: '$455', monthly_income: '$75000'
    },{
        title: 'Helper', week_income: '$455', monthly_income: '$75000'
    },{
        title: 'Advertiser', week_income: '$455', monthly_income: '$75000'
    },]
    return (
        <WeeklyTotalIncomeStyled>
            <TertiaryHeadingMini>Weekly & Total Income</TertiaryHeadingMini>
            {
                [1, 2, 3].map((title, index) => (
                    <Row key={index}>
                        {
                            rolesAndCommissionsData.map(({ title,week_income ,monthly_income }, index) => (
